	...
	namespace math
	{
		...
		struct aabb2
		{
			...
			*/
			...
			void getEdges(vec2<T> edges[4]) const;
			...
			aabb2<T> getInterpolated(const aabb2<T>& other, float d) const;
			...
			void addInternalBox(const aabb2<T>& b);

			// ! Adds an oriented box
			void addInternalBox(const mat3<T>& mat, const aabb2<T>& b);
			...
			///////////////////////////////////////////////////////////////////////////////
				...
				otherwise false. */
			bool intersectsWithBox(const aabb2<T>& other) const;
			...
			bool intersectsWithLine(const vec2<T>& linemiddle, const vec2<T>& linevect, T halflength) const;

			bool intersectsWithLine(const line2<T>& line) const;
			...
			*/
			bool intersectsWithRay(const line2<T>& ray, vec2<T>& outIntersectionNear, vec2<T>& outIntersectionFar) const;
