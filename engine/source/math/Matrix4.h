	...
	namespace math
	{
		...
		struct Matrix4
		{
			...
			Matrix4<T> operator*(const Matrix4<T>& m2) const
			{
				...
				r.m[0][0] = m[0][0] * m2.m[0][0] + m[1][0] * m2.m[0][1] + m[2][0] * m2.m[0][2] + m[3][0] * m2.m[0][3];
				r.m[0][1] = m[0][1] * m2.m[0][0] + m[1][1] * m2.m[0][1] + m[2][1] * m2.m[0][2] + m[3][1] * m2.m[0][3];
				r.m[0][2] = m[0][2] * m2.m[0][0] + m[1][2] * m2.m[0][1] + m[2][2] * m2.m[0][2] + m[3][2] * m2.m[0][3];
				r.m[0][3] = m[0][3] * m2.m[0][0] + m[1][3] * m2.m[0][1] + m[2][3] * m2.m[0][2] + m[3][3] * m2.m[0][3];
	
				r.m[1][0] = m[0][0] * m2.m[1][0] + m[1][0] * m2.m[1][1] + m[2][0] * m2.m[1][2] + m[3][0] * m2.m[1][3];
				r.m[1][1] = m[0][1] * m2.m[1][0] + m[1][1] * m2.m[1][1] + m[2][1] * m2.m[1][2] + m[3][1] * m2.m[1][3];
				r.m[1][2] = m[0][2] * m2.m[1][0] + m[1][2] * m2.m[1][1] + m[2][2] * m2.m[1][2] + m[3][2] * m2.m[1][3];
				r.m[1][3] = m[0][3] * m2.m[1][0] + m[1][3] * m2.m[1][1] + m[2][3] * m2.m[1][2] + m[3][3] * m2.m[1][3];
	
				r.m[2][0] = m[0][0] * m2.m[2][0] + m[1][0] * m2.m[2][1] + m[2][0] * m2.m[2][2] + m[3][0] * m2.m[2][3];
				r.m[2][1] = m[0][1] * m2.m[2][0] + m[1][1] * m2.m[2][1] + m[2][1] * m2.m[2][2] + m[3][1] * m2.m[2][3];
				r.m[2][2] = m[0][2] * m2.m[2][0] + m[1][2] * m2.m[2][1] + m[2][2] * m2.m[2][2] + m[3][2] * m2.m[2][3];
				r.m[2][3] = m[0][3] * m2.m[2][0] + m[1][3] * m2.m[2][1] + m[2][3] * m2.m[2][2] + m[3][3] * m2.m[2][3];

				r.m[3][0] = m[0][0] * m2.m[3][0] + m[1][0] * m2.m[3][1] + m[2][0] * m2.m[3][2] + m[3][0] * m2.m[3][3];
				r.m[3][1] = m[0][1] * m2.m[3][0] + m[1][1] * m2.m[3][1] + m[2][1] * m2.m[3][2] + m[3][1] * m2.m[3][3];
				r.m[3][2] = m[0][2] * m2.m[3][0] + m[1][2] * m2.m[3][1] + m[2][2] * m2.m[3][2] + m[3][2] * m2.m[3][3];
				r.m[3][3] = m[0][3] * m2.m[3][0] + m[1][3] * m2.m[3][1] + m[2][3] * m2.m[3][2] + m[3][3] * m2.m[3][3];
