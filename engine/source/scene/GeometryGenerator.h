...
namespace sh
{
	namespace scene
	{
		...
		public:
			...
			static Model* GetHalfTorusModel(const math::Vector3f& start, const f32 radius, const f32 ringRadius, u32 sides, u32 rings, const math::Vector3f& vtx, const math::Vector3f& vty);
		};
	}
}
